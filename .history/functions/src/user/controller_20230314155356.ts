...
//@all_users API
      catch {const admin = require('firebase-admin');
      admin.initializeApp()};

        // Create a Firebase function to get all users information
exports.getAllUsers = functions.https.onRequest(async (_req, res) => {
    
export async function getAlUsers(req: Request, res: Response): Promise<Response> {
