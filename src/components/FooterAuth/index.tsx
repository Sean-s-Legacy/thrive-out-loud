  ...
  return (
    <div >
        <div className={styles.container}>
            ...
            <div>
              <h2 className={styles.heading}> Wherever you are in your journey, a mentor can help you take the next step.</h2>
              ...
              <div className={styles.bottom}>
                ...
                <h4 className={styles.text}>View/edit profile</h4>
                <h4 className={styles.text}>Settings</h4>
                <h4 className={styles.text}>Help</h4>
                <h4 className={styles.text}>Log out</h4>
                </div>
            </div>
          </div>
        </div>
