...
export default function NameAnduser_Pronouns({user_chosen_name, user_pronouns, user_date_of_birth, errorMessage, updateFields}: UserFormProps){
  ...
  <div>
    ...
    <InputWrapper
      ...
      size = "large"
    />
    {errorMessage['user_chosen_name'] && <p className="error-message"> <img src="/images/Warning.svg" alt="Warning" /> {errorMessage['user_chosen_name']}</p>}
    ...
    <InputWrapper
      ...
      size = "large"
    />
    {errorMessage['user_pronouns'] && <p className="error-message"> <img src="/images/Warning.svg" alt="Warning" /> {errorMessage['user_pronouns']}</p>}
     {/* ADD A TOOLTIP WITH INFO */}
    ...
    {errorMessage['user_date_of_birth'] && <p className="error-message"> <img src="/images/Warning.svg" alt="Warning" /> {errorMessage['user_date_of_birth']}</p>}
  </div>
  )
}
