...
const MENTEE_ONBOARDING_CONTENT = {
  chosenName: {
    ...
    inputs: [
      ...
      required: true,
      errorMessage: "Please provide us a name to refer to you."
      },
      {inputLabel: "Pronouns",
      ...
      required: true,
      errorMessage: "Please provide us with your pronouns."
      },
  ...
  location: {
    ...
    inputs: [
      ...
      required: true,
      errorMessage: "Please enter a city and state in the United States."
      }
    ]
  },
  genderIdentity: {
    ...
    inputs: [
      ...
      required: true,
      errorMessage: "Please select at least one gender identity."
    },
    {
  ...
  sexualOrientation: {
    ...
    inputs: [
      ...
      required: true,
      errorMessage: "Please select at least one orientation."
    },
    {
      type: "match preference",
    ...
    inputs: [
      {
        ...
        required: true,
        errorMessage: "Please select at least one race or ethnic background."
      },
      {
        type: "match preference",
    ...
    inputs: [
      {
        ...
        errorMessage: "Please provide at least one focus area."
      }
    ]
  }
}
